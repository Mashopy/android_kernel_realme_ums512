...
const uint8_t fw_i_arr[]= {
	#include "himax_firmware_xl.i"
};
const uint8_t fw_i_arr_sky[]= {
	#include "himax_firmware_sky.i"
};
const uint8_t fw_i_arr_sky_s19615[]= {
	#include "himax_firmware_sky_s19615.i"
};


struct hx_upgrade_fw_info hx_fw_list[] = {
    {XL_AUO, "XL", BOOT_UPGRADE_FWNAME,  MPAP_FWNAME_TRULY, fw_i_arr, sizeof(fw_i_arr), BOOT_UPGRADE_FWNAME_SIGNED, OPENSHORT_TEST_THRESHOLD_XL},
    {SKY_BOE, "SKY", BOOT_UPGRADE_FWNAME_SKY,  MPAP_FWNAME_SKY, fw_i_arr_sky, sizeof(fw_i_arr_sky), BOOT_UPGRADE_FWNAME_SIGNED_SKY, OPENSHORT_TEST_THRESHOLD_SKY},
    {SKY_BOE, "SKY", BOOT_UPGRADE_FWNAME_SKY_S19615,  MPAP_FWNAME_SKY, fw_i_arr_sky_s19615, sizeof(fw_i_arr_sky_s19615), BOOT_UPGRADE_FWNAME_SIGNED_SKY_S19615, OPENSHORT_TEST_THRESHOLD_SKY},
};
...
static int __init himax_common_init(void)
{
	...
	if (!(strncmp(lcd_str,"lcd_hx83102d_truly_mipi_hd",strlen("lcd_hx83102d_truly_mipi_hd")))) {
		hx_ctpmodule = 0;
		I("This is lcd_hx83102d_truly_mipi_hd\n");
	} else if (!(strncmp(lcd_str,"lcd_hx83102d_truly_mipi_hd_temp",strlen("lcd_hx83102d_truly_mipi_hd_temp")))) {
		hx_ctpmodule = 0;
		I("This is lcd_hx83102d_truly_mipi_hd_temp\n");
	} else if (!(strncmp(lcd_str,"lcd_hx83102d_skyworth_mipi_hd",strlen("lcd_hx83102d_skyworth_mipi_hd")))) {
		hx_ctpmodule = 2;
		I("This is lcd_hx83102d_skyworth_mipi_hd\n");
	} else {
		E("nothing match lcd name\n");
		return 0;
	}
