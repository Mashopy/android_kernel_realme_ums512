...
#define SYSTEM_WIFI_612CONFIG_FILE "/vendor/etc/wifi_board_612config.ini"
...
int get_wifi_config_param(struct wifi_conf_t *p)
{
    ...
    if(strstr(saved_command_line,"board_id=S19612AA1") ||
        ...
        strstr(saved_command_line,"board_id=S19612EA1") ||
        strstr(saved_command_line,"board_id=S19612FA1") ||
        strstr(saved_command_line,"board_id=S19612GA1") ||
        strstr(saved_command_line,"board_id=S19612HA1") ||
        strstr(saved_command_line,"board_id=S19612JA1")) {
        pr_info("%s, chip id of marlin3 lite is %d, open %s\n",
            __func__, wcn_get_chip_type(), SYSTEM_WIFI_612CONFIG_FILE);
        return wifi_nvm_parse(SYSTEM_WIFI_612CONFIG_FILE, (void *)p);
    } else {
        pr_info("%s, chip id of marlin3 lite is %d, open %s\n",
