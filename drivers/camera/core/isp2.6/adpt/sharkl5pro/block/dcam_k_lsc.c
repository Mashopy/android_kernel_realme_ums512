...
int dcam_update_lsc(void *in)
{
	...
	pr_info("grid_num %d, grid_x_num %d, grid_y_num %d, grid_width %d\n", info->grid_num_t, info->grid_x_num, info->grid_y_num, info->grid_width);
	for (i = 0; i < 4; i++) {
		pr_info("gain_ch%d %04x %04x %04x %04x %04x %04x %04x %04x %04x %04x %04x %04x %04x %04x %04x %04x\n", i,
			gain_tab[0], gain_tab[1], gain_tab[2], gain_tab[3],
			gain_tab[4], gain_tab[5], gain_tab[6], gain_tab[7],
			gain_tab[8], gain_tab[9], gain_tab[10], gain_tab[11],
			gain_tab[12], gain_tab[13], gain_tab[14], gain_tab[15]);
		gain_tab += info->grid_num_t;
	}
